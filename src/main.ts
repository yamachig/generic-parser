...
export { Rule, BaseEnv, BasePos, UnknownRule, UnknownTarget, Empty, arrayLikeOffsetToPos, getMemorizedStringOffsetToPos, StringPos, ValueOfRule, ParseError } from "./core";
